                ...
                <div className="space-y-4">
                  {[
                    ...
                    <motion.div
                      ...
                      className="relative pl-8 py-4 border-l-4 border-primary/50 bg-card/50 backdrop-blur-sm rounded-r-xl hover:border-primary hover:bg-card/80 transition-all duration-300"
                    >
