...
const benefits = [
  {
    ...
    description: "Ability to produce quick turnaround times in providing IT consultants with required skills to supplement your team's staff on projects"
  },
  {
    icon: Target,
    title: "Reduced Dependency",
    description: "Reduced dependency on regional and national technology solutions providers when your project requires staff augmentation"
  },
  {
    icon: TrendingUp,
    title: "Cost Efficiency",
    description: "Reduced project resource costs with all-inclusive hourly rates for consultants"
  },
  {
    icon: Building2,
    title: "Flexible Solutions",
    description: "Flexibility to provide consultants at your facility or offsite at our offices"
  },
  {
    icon: Users,
    title: "Qualified Talent Pool",
    description: "Large qualified talent pool of consultants so you have access to best talent that fits your company's technical needs and culture"
  },
  {
    icon: Award,
    title: "Proven Experts",
    description: "Ability to provide seasoned consultants to meet your company's fluctuating demands without hiring full-time employees"
  },
];
...
const features = [
  {
    ...
    description: "Supplement your team with skilled IT consultants who can hit the ground running",
    gradient: "from-blue-500 to-cyan-500"
  },
  {
    icon: Target,
    title: "Project Solutions",
    description: "Complete project lifecycle solutions with experienced professionals",
    gradient: "from-purple-500 to-pink-500"
  },
  {
    icon: Shield,
    title: "Vendor Management",
    description: "Comprehensive vendor management services to streamline your operations",
      ...
      >
        ...
        */}
        <div className="absolute inset-0 z-0">
          ...
          {/* Replace with: <img src="/assets/staffing-hero-banner.gif" alt="Staffing Solutions" className="w-full h-full object-cover object-center" /> */}
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                >
                  <span className="text-sm font-semibold text-primary">Staffing Excellence</span>
                </motion.div>
              </motion.div>
              ...
              >
                Your goal is to focus on your core business. Our goal is to help you by offering comprehensive workforce solutions that deliver skilled professionals exactly when you need them.
              </motion.p>
              ...
              >
                <Link href="/contact">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button size="lg" className="text-base px-8 py-6 rounded-lg shadow-lg hover:shadow-primary/50" data-testid="button-get-started">
                      Get Started
                    </Button>
                  </motion.div>
                </Link>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button size="lg" variant="outline" className="text-base px-8 py-6 rounded-lg" data-testid="button-learn-more">
                    Learn More
                  </Button>
                </motion.div>
              </motion.div>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-chart-2/20 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-muted-foreground text-sm">Upload Hero Image/GIF Here</p>
                    <p className="text-xs text-muted-foreground mt-2">800x600 recommended</p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative aspect-[6/5] rounded-2xl overflow-hidden border border-primary/20 shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-br from-chart-2/20 to-primary/20 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-muted-foreground text-sm">Upload About Image Here</p>
                    <p className="text-xs text-muted-foreground mt-2">600x500 recommended</p>
                  </div>
                </div>
            ...
            >
              ...
              <div className="space-y-4 text-lg text-muted-foreground">
                <p>
                  Tech Expertsus is a full service IT Services and Business Services Firm. Our Staff Augmentation, Project Solutions, Vendor Management, and Executive Search services enable us to deliver ideas and solutions that meet all of our customers' IT and Business resource needs.
                </p>
                <p>
                  Our international footprint allows us to tap into multiple labor pools and deliver the best talent to our Fortune 500 customer base.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From staff augmentation to executive search, we provide end-to-end staffing solutions
            </p>
          </motion.div>
      ...
      <section className="relative py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <div className="inline-block mb-4">
              <div className="px-4 py-2 bg-primary/10 border border-primary/20 rounded-full">
                <span className="text-sm font-semibold text-primary">Value Proposition</span>
              </div>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              Why Partner With Us
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We understand your project and resource needs to deliver exceptional value
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-block mb-4">
                <div className="px-4 py-2 bg-primary/10 border border-primary/20 rounded-full">
                  <span className="text-sm font-semibold text-primary">Executive Placement</span>
                </div>
              </div>
              ...
              <div className="space-y-4 text-lg text-muted-foreground mb-8">
                ...
                <p>
                  We source, screen, and interview potential candidates based on your requirements, then provide you with a list of top-tier candidates. You conduct final interviews and make the final hiring decision.
                </p>
              </div>
              ...
              <div className="relative aspect-[6/7] rounded-2xl overflow-hidden border border-primary/20 shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-chart-2/20 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-muted-foreground text-sm">Upload Recruiting Image Here</p>
                    <p className="text-xs text-muted-foreground mt-2">600x700 recommended</p>
                  </div>
                </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Let us help you find the perfect talent with our comprehensive staffing solutions. Contact us today to get started.
            </p>
