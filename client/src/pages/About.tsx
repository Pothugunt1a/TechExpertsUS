...
import { 
  ...
  MessageSquare, Star, Shield, Handshake,
  Globe, Calendar, MapPin, CheckCircle2, ArrowRight,
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="relative p-8 bg-gradient-to-br from-card/70 to-card/40 backdrop-blur-xl border border-primary/10 rounded-2xl">
                <MapPin className="w-10 h-10 text-primary mb-4" />
                <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Our Locations</h3>
              ...
              <div className="relative p-8 bg-gradient-to-br from-card/70 to-card/40 backdrop-blur-xl border border-primary/10 rounded-2xl">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Since 2012</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Established in 2012, Tech Expertsus has grown to be the preferred IT partner across various industry verticals.
                </p>
              </div>
            </motion.div>
          </div>
              ...
              <div className="relative h-full bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl border border-primary/20 rounded-3xl overflow-hidden">
                ...
                <div className="p-12">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Provide professional consulting services and viable resources to ensure complete client satisfaction and long-term commitment through high quality standards.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative h-full bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl border border-chart-2/20 rounded-3xl overflow-hidden">
                ...
                <div className="p-12">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    To be recognized as a global leader in providing IT Services and Technology solutions while fulfilling customer needs with knowledge, experience and urgency.
                  </p>
                </div>
              </div>
            </motion.div>
