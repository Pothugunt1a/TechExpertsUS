    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-10 md:py-16">
        <div className="max-w-7xl mx-auto px-3 lg:px-4">
          ...
          >
            <h2 className="text-5xl md:text-6xl font-bold mb-8 text-white">Building Secure & Resilient Infrastructure</h2>
      ...
      <section className="relative py-10 md:py-16 bg-gradient-to-b from-card/30 to-background">
        <div className="max-w-7xl mx-auto px-3 lg:px-4">
          <motion.div
            ...
            className="text-center mb-8"
          >
            <h2 className="text-5xl md:text-6xl font-bold mb-4 text-white">Wide Range of Solutions</h2>
