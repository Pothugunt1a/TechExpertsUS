...
export default function Services() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Technology Platforms - Single Column Layout */}
        ...
        <div className="max-w-7xl mx-auto px-3 lg:px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              Advanced cloud, enterprise, and emerging technology platforms
            </p>
          </motion.div>
              ...
              >
                <div className="relative h-full bg-card/50 backdrop-blur-sm border border-primary/10 rounded-2xl p-8 hover:border-primary/40 transition-all duration-500 overflow-hidden">
                  ...
                  <div className="relative z-10 flex items-start gap-6">
                    <motion.div
                      className="flex-shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/20 to-chart-2/20 flex items-center justify-center group-hover:shadow-2xl group-hover:shadow-primary/40"
                      whileHover={{
                        rotate: [0, -10, 10, -10, 0],
                        scale: 1.1,
                      }}
