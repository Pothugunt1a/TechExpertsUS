...
export default function Consulting() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-10 md:py-16 pt-32 pb-8 overflow-hidden">
        {/* Background Image */}
      ...
      <section className="relative -mt-12 -mb-16 z-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="relative py-12 md:py-20 pt-28 bg-gradient-to-b from-card/30 to-background overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
