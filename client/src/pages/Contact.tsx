    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <motion.div
            className="absolute top-64 right-[15%] text-chart-2/10"
            animate={{
              y: [0, 25, 0],
              rotate: [0, -8, 0],
            }}
          ...
          <motion.div
            className="absolute bottom-48 left-[20%] text-chart-3/10"
            animate={{
              y: [0, -20, 0],
              rotate: [0, 12, 0],
            }}
          ...
          <motion.div
            className="absolute top-1/2 right-[8%] text-primary/8"
            animate={{
              y: [0, 35, 0],
              rotate: [0, -10, 0],
            }}
          ...
          <motion.div
            className="absolute bottom-32 right-[25%] text-chart-2/8"
            animate={{
              y: [0, -28, 0],
              rotate: [0, 15, 0],
            }}
          ...
          >
            <Phone className="w-18 h-18" />
          </motion.div>

          <motion.div
            className="absolute top-96 left-[5%] text-chart-4/10"
            animate={{
              y: [0, 22, 0],
              rotate: [0, -12, 0],
            }}
